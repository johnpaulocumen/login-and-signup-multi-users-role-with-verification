...
function send_password_reset($get_name,$get_email,$token)
{
    ...
    $mail->setFrom('xxxxxxxxx@gmail.com', $get_name);
    ...
    <br/><br/>
    <a href='http://localhost/login-and-signup-multi-users-role-with-verification/password-change.php?token=$token&email=$get_email'>Click here</a>";
